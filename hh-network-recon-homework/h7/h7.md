...
-- Edit: we dont actually need to run any python script, we can apparently just change the file format straight away from complex16s to cs8 and use rtl_433 with `rtl_433 -Y autolevel filename.cs8`
